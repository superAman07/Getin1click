            ...
            {showDropdown && (
              <div className="absolute right-0 top-full mt-2 w-48 bg-white border border-slate-200 rounded-lg shadow-lg z-10 animate-in slide-in-from-top-2 duration-200">
                <button
                  ...
                  className="w-full px-4 py-3 text-left text-slate-700 hover:bg-slate-50 flex items-center gap-3 transition-colors first:rounded-t-lg"
                >
                ...
                <button
                  ...
                  className="w-full px-4 py-3 text-left text-red-600 hover:bg-red-50 flex items-center gap-3 transition-colors last:rounded-b-lg"
                >
    ...
    <div className="min-h-screen bg-slate-50 p-4 lg:p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-8">
          ...
          <button 
            onClick={() => openModal()} 
            className="bg-cyan-500 hover:bg-cyan-600 text-white px-6 py-3 rounded-xl flex items-center gap-3 font-medium transition-all duration-200 hover:shadow-lg active:scale-95 self-start lg:self-auto"
          >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 pt-4">
                    <button 
                      type="button" 
                      onClick={closeModal} 
                      className="flex-1 px-6 py-3 rounded-xl text-slate-600 bg-slate-100 hover:bg-slate-200 font-medium transition-all duration-200"
                    >
                      Cancel
                    </button>
                    <button 
                      ...
                      className="flex-1 px-6 py-3 rounded-xl bg-cyan-500 text-white hover:bg-cyan-600 disabled:bg-cyan-300 font-medium transition-all duration-200 hover:shadow-lg active:scale-95 flex items-center justify-center gap-2"
                    >
...
//                 <button onClick={() => openModal()} className="bg-cyan-500 text-white cursor-pointer px-4 py-2 rounded-lg flex items-center hover:bg-cyan-600 transition">
...
//                                         <button onClick={() => openModal(cat)} className="p-2 text-slate-500 hover:text-cyan-600 cursor-pointer transition-colors">
//                                             <Edit size={18} />
//                                         </button>
//                                         <button onClick={() => handleDelete(cat.id)} className="p-2 text-slate-500 hover:text-red-600 cursor-pointer transition-colors">
//                                             <Trash2 size={18} />
//                                         </button>
//                                     </div>
//                                 </li>
...
//                 </div>
//             ) : (
//                 !loading && <p className="text-center text-slate-500">No categories found. Click "Add Category" to create one.</p>
//             )}
...
//                                 <button type="button" onClick={closeModal} className="px-4 py-2 cursor-pointer rounded-lg text-slate-600 bg-slate-100 hover:bg-slate-200">
//                                     Cancel
//                                 </button>
//                                 <button type="submit" disabled={isSubmitting} className="px-4 py-2 cursor-pointer rounded-lg bg-cyan-500 text-white hover:bg-cyan-600 disabled:bg-cyan-300 flex items-center">

...
import { ProfessionalProfileData, ProfilePhoto, QAItem, Service } from "@/types/profileTypes";
...
export default function SettingsPage() {
    ...
    const completion = useMemo(() => {
        ...
        let total = 0, done = 0;
        const add = (cond: boolean) => { total++; if (cond) done++; };
    ...
    }, [aboutCompany, companyEmail, companyLogo, companyName, companyPhone, companySize, photos.length, profilePic, qas, selectedServices.length, website, yearInBusiness, yourName, linkedIn, twitter, facebook, instagram]);

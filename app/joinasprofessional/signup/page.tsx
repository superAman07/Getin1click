      ...
      case STEPS.ACCOUNT:
        return (
          <div>
            ...
            <button onClick={handleAccountCreation} disabled={isLoading} className="w-full bg-blue-600 text-white p-3 mt-6 rounded-md hover:bg-blue-700 disabled:bg-blue-400">
      ...
      case STEPS.PROFILE:
        return (
          <div>
            ...
            <button onClick={() => router.push('/professional/dashboard')} className="w-full bg-green-600 text-white p-3 mt-6 rounded-md hover:bg-green-700">

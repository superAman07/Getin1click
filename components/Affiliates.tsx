...
Start earning by referring people who need  service <br/> providers to do their everyday jobs          </p>
      ...
      {/* Options */}
      <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl w-full px-6">
        {/* Option 1 */}
        <div className="bg-white rounded-2xl shadow-md p-8 hover:shadow-lg hover:scale-[1.02] transition">
          <span className="bg-[#0a0a23] text-white text-sm px-4 py-1 rounded-full font-medium">
            Option 1
          </span>
          ...
          <p className="mt-4 text-gray-500 text-lg">
            Commission is depending on the service category - so long as it receives at least
            one response from a professional or business (even if they never actually book!).
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-md p-8 hover:shadow-lg hover:scale-[1.02] transition">
          ...
          <h2 className="mt-4 text-2xl font-semibold text-gray-900">
            Send us <span className="text-indigo-600">professionals</span> providing services
          </h2>
          <p className="mt-4 text-gray-600 text-lg-bold ">
            £1 for sign-up from a professional who's clicked one of your affiliate links + 20% of
            revenue generated from them for the first 12 months.
          </p>
        </div>
      </div>
    </section>
 ...
 <section className="w-full bg-white py-16 flex justify-center items-center flex-col">
       <h1 className=" font-bold text-center " style={{fontSize : "50px" , marginTop:"-60px"}}>Getting starting is simple</h1>

      <div className="relative max-w-4xl w-full px-6 mt-10">
        {/* Vertical line */}
        <div className="absolute top-0 left-6 md:left-8 h-full border-l border-gray-300"></div>

        <div className="space-y-16">
          {/* Step 1 */}
          <div className="flex items-start relative">
            <div className="flex items-center justify-center w-12 h-12 rounded-full border border-gray-400 bg-white text-lg font-bold text-gray-900 z-10">
              1
            </div>
            <div className="ml-6">
          ...
          <div className="flex items-start relative">
            ...
            <div className="ml-6">
              <h2 className="text-lg md:text-xl font-semibold text-gray-900">
                Earn commission <span role="img" aria-label="money">💸</span>
              </h2>
            </div>
          </div>
        </div>
...
<section className="w-full bg-white py-16 flex justify-center items-center flex-col">
       <h1 className=" font-bold text-center " style={{fontSize : "50px" , marginTop:"-60px"}}>How affiliates get paid</h1>

      <div className="relative max-w-4xl w-full px-6 mt-10">
        {/* Vertical line */}

        <p>We pay affiliates for every lead or project sent to us that can be attributed back to one of their affiliate links, so long as:</p>
        <br/>
...
<p>These service providers buy packs of credits on Bark that they can then exchange for the project details generated above to find high-value new leads for their business.</p>
    ...
    <section className="w-full bg-white py-16 flex justify-center items-center flex-col">
      ...
      <div className="relative max-w-4xl w-full px-6 mt-10">
        ...
        <p>1. Earn up to $100/£80 per valid project request.</p>
       <p>2. Get paid all year round - we have service providers looking for leads constantly.</p>
<p>3. Earn commission in categories that, to our knowledge, you simply can’t profit from elsewhere.</p>
<p>4. We’ll support you with a dedicated in-house team available to answer your questions 24/7.</p>
<p> 5. We’ll provide you with frequently refreshed assets and offers so you can maximise your promotion.</p>
      </div>
    </section>

      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4">
            <h3 className="font-semibold text-gray-900 text-lg">For Customers</h3>
          ...
          {/* For Professionals */}
          <div className="space-y-4">
            <h3 className="font-semibold text-gray-900 text-lg">For Professionals</h3>
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-gray-600 hover:text-blue-600 transition-colors">
                  How it works
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
                <div className="flex text-green-500">
                  {"★★★★★".split("").map((star, i) => (
                    <span key={i} className={i < 4 ? "text-green-500" : "text-gray-300"}>
                      {star}
                    </span>
                  ))}
                </div>
                <span className="text-sm font-medium text-gray-900">TrustScore 4.1</span>
              </div>

export default function Customershiw() {
    return(
        <div className="min-h-screen flex flex-col items-center justify-center  text-gray-800 mt-40">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#0c1445] leading-snug mt-20">
                        How It Works 
                     </h2>


    <section className="w-full bg-gray-50 py-16 px-6 md:px-16 flex flex-col md:flex-row items-center md:items-start gap-12 mt-20">
          {/* Right Side Text */}
      <div className="w-full md:w-1/2 text-center md:text-left mt-20 text-center md:text-left">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 text-center md:text-left mt-50 ">
         Tell us what you need
        </h2>
        <p className="text-gray-600 leading-relaxed mb-6" style={{fontSize: "18px"}}>
          Whatever the service you're looking for, we'll help you find a professional for the job.
        </p>

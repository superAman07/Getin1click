export default function Howitwork(){
    return(
     ...
     <h3 className=" font-bold " style={{fontSize : "30px" , marginTop:"-60px"}}>How it works</h3>
     <h1 className=" font-bold " style={{fontSize : "50px"}}>Bark for Pros</h1>
          <p className="text-lg max-w-2xl text-center" style={{fontSize: "18px"}}>
Bark is the Amazon of services. Millions of people use <br /> us worldwide to find what they need every day.    </p>

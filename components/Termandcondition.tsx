...
Introduction                </h2>
                ...
                <p className="mt-6 text-slate-500 text-base leading-relaxed" style={{ fontFamily: "'Inter', sans-serif" }}>
                 These Terms and Conditions govern the Facilitation Services that Bark.com will make available to you, and are in addition to any website terms of use that apply from time to time, to your use of the Website (as defined below). These Terms and Conditions (also, “Agreement”) contain important information about your legal rights and obligations, and is a legally binding agreement between you (“you”, the “Customer”), and Bark.com Global Limited ("we", "us", "Bark").                </p>

                <p className="mt-4 text-slate-500 text-base leading-relaxed" style={{ fontFamily: "'Inter', sans-serif" }}>
                 You should read these Terms and Conditions carefully before using our Bark.com Website, as by using our Platform and Facilitation Services, and by clicking accept when prompted to the Website, you agree to be bound by all agreements which constitute Bark’s Terms of Service, including the Terms of Use, Privacy Policy and Cookies Policy, and that you will comply with them.                </p>
